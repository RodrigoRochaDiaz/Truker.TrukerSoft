...
public class MainMenuActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvHeaderName = (TextView) navHeaderView.findViewById(R.id.textViewName);
        TextView tvHeaderEmail = (TextView) navHeaderView.findViewById(R.id.textViewEmail);
