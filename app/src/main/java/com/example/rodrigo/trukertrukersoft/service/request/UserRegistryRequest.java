...
public class UserRegistryRequest {
    ...
    public UserRegistryRequest(int userId, String username, String password, int personId, String fullName, String phone, short age, int ladaId, String email, String license) {
        UserId = userId;
        Username = username;
        Password = password;
        PersonId = personId;
